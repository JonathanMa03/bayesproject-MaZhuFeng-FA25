...
# For installing all packages required
install.packages(c(
  "broom", "knitr", "tidyverse", "dplyr", "ggplot2", "stringr",
  "ggthemes", "scales", "brms", "bayesplot", "rstan",
  "caret", "sjPlot", "tidyr", "mclust"
))
```
...
tidy_miss <- tidy(miss_model)
significant_results <- tidy_miss[tidy_miss$p.value < 0.05, ]
kable(significant_results, caption = "Significant Predictors of Missingness")
```
